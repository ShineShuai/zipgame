...
export const ALGO_VERSION = 4; // bump when generator/solver output changes for a given seed. v2: solver propagation + scaled node caps in generate() (fewer walls, faster). v3: K ~ Normal peaked at 30% of range. v4: every attempt seeded with 40% random walls, fewer attempts
